...
begin
    ...
    else if(data_valid && (parity_bytes == 5'd2))
    begin
        p1_2 <= p0_2 ^ mult2_g1;
        p0_2 <= mult2_g0;
    end
...
assign feedback26 = current_data ^ p[25];
...
begin
    ...
    else if(data_valid && (parity_bytes == 5'd26))
    begin
...
begin
    ...
    if(parity_bytes == 6'd2)
    begin
        case(parity_rd_idx)
            6'd0: parity_out = p1_2;
            6'd1: parity_out = p0_2;
    ...
    begin
        case(parity_rd_idx)
            6'd0 : parity_out = p[25];
            6'd1 : parity_out = p[24];
            6'd2 : parity_out = p[23];
            6'd3 : parity_out = p[22];
            6'd4 : parity_out = p[21];
            6'd5 : parity_out = p[20];
            6'd6 : parity_out = p[19];
            6'd7 : parity_out = p[18];
            6'd8 : parity_out = p[17];
            6'd9 : parity_out = p[16];
            6'd10: parity_out = p[15];
            6'd11: parity_out = p[14];
            6'd12: parity_out = p[13];
            6'd13: parity_out = p[12];
            6'd14: parity_out = p[11];
            6'd15: parity_out = p[10];
            6'd16: parity_out = p[9];
            6'd17: parity_out = p[8];
            6'd18: parity_out = p[7];
            6'd19: parity_out = p[6];
            6'd20: parity_out = p[5];
            6'd21: parity_out = p[4];
            6'd22: parity_out = p[3];
            6'd23: parity_out = p[2];
            6'd24: parity_out = p[1];
            6'd25: parity_out = p[0];
            default: parity_out = 8'h00;
        endcase
    end
